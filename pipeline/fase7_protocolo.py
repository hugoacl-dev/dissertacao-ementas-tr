"""
fase7_protocolo.py — Protocolo executável da Fase 7
...
def validar_resposta_llm_judge(payload: dict[str, Any]) -> dict[str, dict[str, Any]]:
    ...
    Args:
        payload: Estrutura JSON já desserializada.

    Returns:
        O payload normalizado, com justificativas sem espaços laterais.

    Raises:
        ValueError: Se o payload não respeitar o contrato esperado.
    """
