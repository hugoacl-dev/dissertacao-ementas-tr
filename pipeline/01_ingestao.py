...
Converte o dump binário PostgreSQL (custom format) do sistema TR-ONE em:
  - Um banco SQLite local (data/banco_tr_one.sqlite) para consultas futuras.
...
def verificar_pg_restore() -> None:
    ...
    try:
        ...
        raise RuntimeError(
            ...
            "O arquivo dump_tr_one.sql é um PostgreSQL Custom Dump (binário comprimido).\n"
