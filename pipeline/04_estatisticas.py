...
def gerar_relatorio(
    ...
    fase1 = {
        "nome": "Ingestão",
        "descricao": "Extração dos votos (fundamentações) e ementas do banco PostgreSQL do sistema TR-ONE.",
        ...
        "fonte": "TR-ONE / PostgreSQL",
        "artefatos": [
            {"nome": "dump_tr_one.sql", "tamanho_mb": _file_size_mb(dump_path), "tipo": "entrada", "conteudo": "Dump binário PostgreSQL (custom format)"},
    ...
    dicas = {
        ...
        "temporal": (
            f"Quantidade de processos recebidos pelas relatorias da Turma Recursal no sistema TR-ONE a cada ano, "
