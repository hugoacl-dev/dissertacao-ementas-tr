"""
fase7_predicoes_utils.py — Helpers compartilhados para predições da Fase 7
...
from fase7_protocolo import validar_registro_caso_avaliacao, validar_registro_predicao
