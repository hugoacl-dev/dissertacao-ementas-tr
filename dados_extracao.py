...
DUMP_PATH = 'dump_sistema_judicial.sql'
DB_PATH = 'banco_sistema_judicial.sqlite'
...
def verificar_dependencias():
    ...
    try:
        ...
        logging.error("O arquivo 'dump_sistema_judicial.sql' não é um SQL em texto plano (apesar da extensão).")
